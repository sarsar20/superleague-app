      ...
      <div style={styles.container}>
        <div style={styles.hero}>
          <div>
            ...
            <h1 style={styles.title}>Predictor App</h1>
            <p style={styles.subtitle}>
              Διάλεξε για κάθε παιχνίδι μόνο αποτέλεσμα: νίκη γηπεδούχου,
              ισοπαλία ή νίκη φιλοξενούμενου. Η βαθμολογία ενημερώνεται αυτόματα
              και ζωντανά.
            </p>
          </div>
          ...
          <div style={styles.heroSide}>
            <div style={styles.statPill}>
              Συμπληρωμένα: <strong>{completedMatches}/12</strong>
            </div>
        ...
        <div style={styles.topCards}>
          <div
            style={{
              ...styles.leaderCard,
              boxShadow: `0 20px 45px ${leader.glow}`,
            }}
          >
          ...
          <div style={styles.infoCard}>
            ...
            <div style={styles.infoText}>
              Νίκη = 3β • Ισοπαλία = 1β + 1β • Ήττα = 0β
            </div>
          </div>
        </div>
              ...
              <div key={round} style={styles.roundCard}>
                ...
                <div style={styles.matchesWrap}>
                  {data.matches.map((match) => {
                    ...
                    return (
                      <div key={match.idx} style={styles.matchCard}>
                        <div
                          style={{
                            ...styles.teamBox,
                            ...
                            color: home.accent,
                            boxShadow: `0 12px 24px ${home.glow}`,
                          }}
                        >
                          <div style={styles.teamBadge}>{home.badge}</div>
                          <div>
                            <div style={styles.teamName}>{home.name}</div>
                        ...
                        <div
                          style={{
                            ...
                            color: away.accent,
                            boxShadow: `0 12px 24px ${away.glow}`,
                          }}
                        >
                          <div style={styles.teamBadge}>{away.badge}</div>
                          <div>
                            <div style={styles.teamName}>{away.name}</div>
          ...
          <div style={styles.sidebar}>
            ...
            <div style={styles.legendCard}>
              ...
              <div style={styles.legendRow}>
                <span style={styles.legendKey}>1</span> Νίκη γηπεδούχου
              </div>
              <div style={styles.legendRow}>
                <span style={styles.legendKey}>Χ</span> Ισοπαλία
              </div>
              <div style={styles.legendRow}>
                <span style={styles.legendKey}>2</span> Νίκη φιλοξενούμενου
              </div>
            </div>
          </div>
        </div>
...
const styles = {
  page: {
    minHeight: "100vh",
    background:
      "linear-gradient(180deg, #07111f 0%, #0d1b2a 40%, #eef4ff 100%)",
  ...
  bgOrb2: {
    ...
    borderRadius: "50%",
    background:
      "radial-gradient(circle, rgba(22,163,74,0.22), transparent 70%)",
  },
  container: {
    maxWidth: 1320,
    margin: "0 auto",
